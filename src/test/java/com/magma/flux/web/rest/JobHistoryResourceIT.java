...
import com.magma.flux.repository.JobHistoryRepository;
import com.magma.flux.service.dto.JobHistoryDTO;
import com.magma.flux.service.mapper.JobHistoryMapper;
...
class JobHistoryResourceIT {
    ...
    void createJobHistory() throws Exception {
        ...
        assertThat(testJobHistory.getPersonId()).isEqualTo(DEFAULT_PERSON_ID);
    ...
    void putNewJobHistory() throws Exception {
        ...
        updatedJobHistory.jobId(UPDATED_JOB_ID).personId(UPDATED_PERSON_ID).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
        ...
        assertThat(testJobHistory.getPersonId()).isEqualTo(UPDATED_PERSON_ID);
    ...
    void fullUpdateJobHistoryWithPatch() throws Exception {
        ...
        partialUpdatedJobHistory.jobId(UPDATED_JOB_ID).personId(UPDATED_PERSON_ID).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
