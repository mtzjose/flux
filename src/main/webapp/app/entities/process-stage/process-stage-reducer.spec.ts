...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESSSTAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROCESSSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROCESSSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROCESSSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROCESSSTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROCESSSTAGE actions', async () => {
      const expectedActions = [
        {
