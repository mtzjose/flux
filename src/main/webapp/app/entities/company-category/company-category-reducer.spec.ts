...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYCATEGORY actions', async () => {
      const expectedActions = [
        {
