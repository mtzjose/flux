  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fluxApp.school.home.createOrEditLabel" data-cy="SchoolCreateUpdateHeading">
            <Translate contentKey="fluxApp.school.home.createOrEditLabel">Create or edit a School</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="school-id"
                  label={translate('fluxApp.school.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('fluxApp.school.name')}
                id="school-name"
                name="name"
                data-cy="name"
                type="text"
