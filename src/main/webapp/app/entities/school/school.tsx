  ...
  return (
    <div>
      <h2 id="school-heading" data-cy="SchoolHeading">
        <Translate contentKey="fluxApp.school.home.title">Schools</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fluxApp.school.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fluxApp.school.home.createLabel">Create new School</Translate>
          </Link>
        </div>
      </h2>
        ...
        {schoolList && schoolList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="fluxApp.school.id">Id</Translate>
                </th>
                <th>
                  <Translate contentKey="fluxApp.school.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fluxApp.school.home.notFound">No Schools found</Translate>
            </div>
          )
        )}
      </div>
