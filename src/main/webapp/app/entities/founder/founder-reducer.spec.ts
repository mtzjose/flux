...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './founder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOUNDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOUNDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOUNDER actions', async () => {
      const expectedActions = [
        {
