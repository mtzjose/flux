...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gender.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENDER actions', async () => {
      const expectedActions = [
        {
