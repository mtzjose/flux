...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pronoun.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRONOUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRONOUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRONOUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRONOUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRONOUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRONOUN actions', async () => {
      const expectedActions = [
        {
