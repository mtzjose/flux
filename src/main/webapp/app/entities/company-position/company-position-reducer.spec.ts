...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYPOSITION actions', async () => {
      const expectedActions = [
        {
