...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTSOURCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTACTSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTACTSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTACTSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTACTSOURCE actions', async () => {
      const expectedActions = [
        {
