...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './company-categories.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYCATEGORIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPANYCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPANYCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPANYCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPANYCATEGORIES actions', async () => {
      const expectedActions = [
        {
