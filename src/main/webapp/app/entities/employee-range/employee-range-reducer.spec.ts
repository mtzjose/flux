...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEERANGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEERANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEERANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEERANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEERANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEERANGE actions', async () => {
      const expectedActions = [
        {
