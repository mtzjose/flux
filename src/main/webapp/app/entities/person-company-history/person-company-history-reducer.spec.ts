...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './person-company-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONCOMPANYHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONCOMPANYHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONCOMPANYHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONCOMPANYHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONCOMPANYHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONCOMPANYHISTORY actions', async () => {
      const expectedActions = [
        {
