...
export const OpportunityDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fluxApp.opportunity.delete.question">
        <Translate contentKey="fluxApp.opportunity.delete.question" interpolate={{ id: opportunityEntity.id }}>
