...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './founder-positions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOUNDERPOSITIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOUNDERPOSITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOUNDERPOSITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOUNDERPOSITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOUNDERPOSITIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOUNDERPOSITIONS actions', async () => {
      const expectedActions = [
        {
