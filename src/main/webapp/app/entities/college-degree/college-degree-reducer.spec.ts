...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLEGEDEGREE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLLEGEDEGREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLEGEDEGREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLEGEDEGREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLEGEDEGREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLEGEDEGREE actions', async () => {
      const expectedActions = [
        {
