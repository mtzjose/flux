...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './race.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RACE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RACE actions', async () => {
      const expectedActions = [
        {
