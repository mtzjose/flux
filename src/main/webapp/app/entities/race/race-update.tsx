...
export const RaceUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fluxApp.race.home.createOrEditLabel" data-cy="RaceCreateUpdateHeading">
            <Translate contentKey="fluxApp.race.home.createOrEditLabel">Create or edit a Race</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="race-id"
                  label={translate('fluxApp.race.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('fluxApp.race.name')}
                id="race-name"
                name="name"
                data-cy="name"
                type="text"
